      ...
      <div class="auto-container">
         <div class="row">
            <div class="col-lg-3 col-12 mx-auto text-lg-left text-center pl-0 mb-lg-0 mb-4">
               <div class="logo">
                  <a href="#">
                     <img class="img-fluid" src="{{ asset('logo.png') }}" alt="logo" style="width:180px; height:auto;">
                  </a>
               </div>
            </div>
            <!-- end col -->
                  ...
                  <nav class="navbar navbar-expand-lg justify-content-left">
                     <ul class="navbar-nav">
                        ...
                        @foreach ($pages as $page)
                           <li class="nav-item @if (\Request::is($page->slug)) active @endif">
                              <a href="{{ route('page.show', $page->slug) }}" class="nav-link">
                                 {{ $page->title }}
                              </a>
                           </li>
                        @endforeach
