<template>
    <div class="row">
        <h3 class="mb-0">Registered Streams</h3>
        <nav class="mb-3">
            <ol class="breadcrumb">
                        ...
                        <div class="col-md-6 col-3 ms-lg-auto">
                            <div class="flex-wrap text-end">
                                <div class="card-action">
                                    <button type="button" class="btn btn-primary d-none d-sm-inline-block" @click="showCreateStreamModal">
                                        <i class="bx bx-plus-circle me-2"></i>
                                        Add Stream
                                    </button>
                                    <button type="button" class="btn btn-primary btn-icon d-sm-none" @click="showCreateStreamModal">
