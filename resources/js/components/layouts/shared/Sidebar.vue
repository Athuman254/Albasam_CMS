<template>
   <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
         ...
         <li v-if="canAny(['access-pages-workspace'])" :class="{ 'menu-item': true, 'active open': $page.url.startsWith('/admin/website') }">
            ...
            <ul class="menu-sub">
               <li v-if="can('access-pages-workspace')" :class="{ 'menu-item': true, 'active': $page.url.startsWith('/admin/website/customisations') }">
                  <Link :href="route('customisations.index')" class="menu-link">
                     <div class="text-truncate">Customisation</div>
                  </Link>
               </li>
               ...
               <li v-if="can('access-pages-workspace')" :class="{ 'menu-item': true, 'active': $page.url.startsWith('/admin/website/menus') }">
                  <Link :href="route('menus.index')" class="menu-link">
                     <div class="text-truncate">Menu Items</div>
                  </Link>
               </li>
               <li class="menu-item">
                  <Link href="#" class="menu-link">
      ...
      <ul v-if="loggedInAs === 'fundraiser'" class="menu-inner py-1">
         <!-- Dashboard -->
         <li :class="{ 'menu-item': true, 'active': $page.url.startsWith('/dashboard') }">
            <Link :href="route('dashboard')" class="menu-link">
               <span>
                  <i class="menu-icon tf-icons bx bx-home-alt"></i>
               </span>
