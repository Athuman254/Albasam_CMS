                        ...
                        <div class="col-md-6 col-3 ms-lg-auto">
                            <div class="flex-wrap text-end">
                                <div class="card-action">
                                    <Link href="/admin/employees/teachers/create" class="btn btn-primary d-none d-sm-inline-block">
...
<!--                            <span class="me-1">{{ props.rowData.first_name }}</span> {{ props.rowData.last_name }}-->
                        </div>
                    </template>
                    <template v-slot:actions="props">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <Link class="dropdown-item" :href="'/admin/employees/teachers/' + props.rowData.hashid + '/edit'">
