                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="row row-gap-1">
                        <div class="col-md-3 col-9">
                            <input type="search" id="search" class="form-control bg-muted-lt rounded-2" placeholder="Search Pages"
                        ...
                        <form id="createForm" @submit.prevent="updatePage">
                            ...
                            <div class="mb-3">
                                <label class="row d-flex">
                                    ...
                                    <span class="col-auto">
                                        <label class="form-check form-switch">
                                            <input v-model="editForm.is_published" class="form-check-input" type="checkbox">
                                        </label>
                                    </span>
                                    <span class="form-check-description">When enabled, the page will appear on the website.</span>
                                </label>
                                <div v-if="editForm.errors.is_published" class="text-danger">{{ editForm.errors.is_published }}</div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
