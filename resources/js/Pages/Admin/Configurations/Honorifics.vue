<template>
               ...
               <div class="flex-wrap text-end">
                  <div class="card-action">
                     <button type="button" class="btn btn-primary d-none d-sm-inline-block"
                             @click="showCreateHonorificModal">
         ...
         <template #actions="props">
            <div class="dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="#" @click="editHonorific(props.rowData)">
   ...
   <div
      class="modal fade"
      id="create-honorific-modal"
      data-bs-backdrop="static"
      tabindex="-1"
      aria-labelledby="create-honorific-modal-label"
      aria-hidden="true"
      ref="createHonorificModal"
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="create-honorific-modal-label">Add Honorific</h5>
               <button
                  type="button"
                  class="btn-close"
            ...
            <div class="modal-body">
               <form id="createForm" @submit.prevent="createHonorific">
                  <div class="mb-3">
   ...
   <div
      class="modal fade"
      id="edit-honorific-modal"
      data-bs-backdrop="static"
      tabindex="-1"
      aria-labelledby="edit-honorific-modal-label"
      aria-hidden="true"
      ref="editHonorificModal"
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="edit-honorific-modal-label">Edit Honorific</h5>
               <button
                  type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
            ...
            <div class="modal-body">
               <form id="createForm" @submit.prevent="updateHonorific">
                  <div class="mb-3">
                     <label for="name" class="form-label">Name</label>
...
export default {
   ...
   methods: {
      showCreateHonorificModal() {
         const modalElement = this.$refs.createHonorificModal;
         const modalInstance = Modal.getOrCreateInstance(modalElement);
         modalInstance.show();
      },
      createHonorific() {
         this.form.post(route('admin.honorifics.store'), {
            onSuccess: () => {
               this.form.reset();
               this.form.clearErrors();
               this.$refs.honorificsTable.reloadTable();
               const modalElement = this.$refs.createHonorificModal;
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Honorific Created Successfully', 'Success')
            },
            onError: (errors) => {
      ...
      editHonorific(rowData) {
         this.editForm.id = rowData.hashid;
         this.editForm.name = rowData.name;
         this.editForm.activated = rowData.activated;
         
         const modalElement = this.$refs.editHonorificModal;
         const modalInstance = Modal.getOrCreateInstance(modalElement);
         modalInstance.show();
      },
      updateHonorific() {
         this.editForm.patch(route('admin.honorifics.update', this.editForm.id), {
            onSuccess: () => {
               this.editForm.reset();
               ...
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Honorific Updated Successfully', 'Success')
            },
            onError: (errors) => {
               this.$toast.error('An error occurred. Please try again', 'Error')
            },
