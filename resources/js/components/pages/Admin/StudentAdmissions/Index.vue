                  ...
                  <div class="col-md-6 col-3 ms-lg-auto">
                     <div class="flex-wrap text-end">
                        <div class="card-action">
                           <Link href="/admin/student-admissions/admission-form"
                                 class="btn btn-primary d-none d-sm-inline-block">
                              <i class="bx bx-plus-circle me-2"></i>
                              New Registration
                           </Link>
                           
                           <Link class="btn btn-primary btn-icon d-sm-none"
                                 href="/admin/student-admissions/admission-form">
                  ...
                  <div class="dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <Link class="dropdown-item"
                              :href="'/admin/student-admissions/' + props.rowData.hashid + '/edit'">
