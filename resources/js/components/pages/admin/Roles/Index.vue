                ...
                <div class="card-header flex-column flex-md-row">
                    <div class="row row-gap-1">
                        <div class="col-md-3 col-9">
                            <input type="search" id="search" class="form-control bg-muted-lt rounded-2" placeholder="Search Roles"
                        ...
                        <div class="col-md-6 col-3 ms-lg-auto">
                            <div class="flex-wrap text-end">
                                <div class="card-action">
                                    <button type="button" class="btn btn-primary d-none d-sm-inline-block" @click="showCreateRoleModal">
                                        <i class="bx bx-plus-circle me-2"></i>
                                        Add Role
                                    </button>

                                    <button type="button" class="btn btn-primary btn-icon d-sm-none" @click="showCreateRoleModal">
                        ...
                        <form id="createForm" @submit.prevent="createRole">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div v-for="permission in permissions" :key="permission.id" class="col-md-4 col-6 text-md-nowrap">
                                            <label class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" :value="permission.id" v-model="form.permissions">
                    ...
                    <div class="modal-body">
                        <form id="createForm" @submit.prevent="updateRole">
                            ...
                            <div class="col-md-12">
                                <label for="permissions" class="h5 form-label mb-3">Permissions</label>
                                <div class="row">
                                    <div v-for="permission in permissions" :key="permission.id" class="col-md-4 col-sm-6 text-md-nowrap">
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" :value="permission.id" v-model="editForm.permissions">
                                            <span class="form-check-label">{{ permission.name }}</span>
                                        </label>
                                    </div>
                                </div>
