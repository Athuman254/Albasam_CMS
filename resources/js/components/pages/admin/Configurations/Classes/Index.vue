<template>
    <div class="row">
        <h3 class="mb-0">Registered Classes</h3>
        <nav class="mb-3">
            <ol class="breadcrumb">
            ...
            <div class="card">
                ...
                >
                    <template #teacher="props">
                        {{ props.rowData.teacher?.employee?.first_name}} {{ props.rowData.teacher?.employee?.last_name}}
                    </template>
...
<!--                                    <input id="divisionId" type="text" v-model="form.division_id" class="form-control">-->
                                    <v-select
                                        id="divisionId"
...
<!--                                    <input id="streamId" type="text" v-model="form.stream_id" class="form-control">-->
                                    <v-select
                                        id="streamId"
                                ...
                                <div class="mb-3">
                                    ...
                                    <v-select
                                        ...
                                        :options="teachers"
                                        label="name"
                                        :reduce="option => option.teacher?.id"
                                    >
                        ...
                        <div class="modal-body">
                            <form id="createForm" @submit.prevent="updateRank">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div v-if="editForm.errors.division_id" class="text-danger">{{ editForm.errors.division_id }}</div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <v-select
                                        ...
                                        :reduce="option => option.id"
                                    ></v-select>
                                    <div v-if="editForm.errors.stream_id" class="text-danger">{{ editForm.errors.stream_id }}</div>
                                </div>
