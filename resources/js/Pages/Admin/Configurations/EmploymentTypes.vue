<template>
   <div class="card">
      ...
      <VueTable
         :fields="fields"
         api-url="datatable/employment-types"
         :append-params="appendParams"
         ref="employmentTypesTable"
      >
      ...
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="create-employment-type-modal-label">Add Employment Type</h5>
               <button
                  type="button"
                  class="btn-close"
   ...
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="edit-employment-type-modal-label">Edit Employment Type</h5>
               <button
                  type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
...
export default {
   ...
   methods: {
      ...
      createEmploymentType() {
         this.form.post(route('admin.employment-types.store'), {
            onSuccess: () => {
               this.form.reset();
               this.form.clearErrors();
               this.$refs.employmentTypesTable.reloadTable();
               const modalElement = this.$refs.createEmploymentTypeModal;
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Employment Type Created Successfully', 'Success')
            },
            onError: (errors) => {
      ...
      updateEmploymentType() {
         this.editForm.patch(route('admin.employment-types.update', this.editForm.id), {
            onSuccess: () => {
               this.editForm.reset();
