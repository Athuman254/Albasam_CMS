                        ...
                        <div v-if="can('add-users')" class="col-md-6 col-3 ms-lg-auto">
                            <div class="flex-wrap text-end">
                                <div class="card-action">
                                    <button type="button" class="btn btn-primary d-none d-sm-inline-block" @click="showCreateUserModal">
                                        <i class="bx bx-plus-circle me-2"></i>
                                        Add User
                                    </button>
                                    <button type="button" class="btn btn-primary btn-icon d-sm-none" @click="showCreateUserModal">
                        ...
                        <form id="createForm" @submit.prevent="createUser">
                            ...
                            <div class="mb-3">
                                <label class="row d-flex">
                                    ...
                                    <span class="col-auto">
                                        <label class="form-check form-switch">
                                            <input v-model="editForm.is_teacher" class="form-check-input" type="checkbox">
                                        </label>
                                    </span>
                                    <span class="form-check-description">When enabled, the user can login into the system as a teacher.</span>
                                </label>
                                ...
                                <div v-for="permission in permissions" :key="permission.id" class="col-md-4 col-6 text-md-nowrap">
                                    <div class="mb-2">
                                        <label class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" :value="permission.id" v-model="permissionForm.permissions">
...
export default {
    ...
    created() {
        Inertia.on('navigate', (event) => {
            if (event.detail.page.url === '/admin/users') {
                this.fetchRoles();
    ...
    methods: {
        ...
        updateUser() {
            this.editForm.patch('/admin/users/' + this.editForm.id, {
                onSuccess: () => {
        ...
        updatePermissions() {
            this.permissionForm.post('/admin/users/' + this.user.hashid + '/permissions', {
                onSuccess: () => {
