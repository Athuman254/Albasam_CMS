                           ...
                           <div class="row">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group mb-3">
                                    <label class="form-label" for="registrationDate">Registration Date <span
                              ...
                              <div class="col-md-6">
                                 <div class="form-group mb-3">
                                    <label class="form-label" for="divisionId">Division <span
                                       class="text-danger ms-1">*</span></label>
                                    <v-select
                                       id="divisionId"
                     ...
                     <transition name="fade">
                        <div v-if="currentStep === 2" class="step">
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="form-label" for="birthCertificateNumber">Birth Certificate
                                       Number</label>
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    <label class="form-label" for="citizenship">Citizenship <span
                                       class="text-danger ms-1">*</span></label>
                              ...
                              <!-- KCPE Score -->
                              <div v-if="['Secondary School', 'High School'].includes(selectedDivision)"
                                   class="col-md-4">
                                 <div class="form-group mb-3">
                              ...
                              <div class="col-md-4">
                                 <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="specialization" class="form-control"
                                           v-model="form.student.specialization"/>
                                    <div v-if="form.errors['student.specialization']" class="text-danger">
                                       {{ form.errors['student.specialization'] }}
                                    </div>
                                 </div>
                              </div>
                           </div>
