<template>
   ...
   <li :class="{ 'menu-item': true, 'active open': $page.url.startsWith('/employee/attendance') }">
      <a href="#" class="menu-link menu-toggle">
         <i class='bx bx-calendar-check menu-icon tf-icons'></i>
         <div class="text-truncate">Attendance</div>
      </a>
      <ul class="menu-sub">
         <li :class="{ 'menu-item': true, 'active': $page.url.startsWith('/employee/attendance/mark') }">
            <Link :href="route('employee.attendance.mark')" class="menu-link">
...
<li :class="{ 'menu-item': true, 'active open': $page.url.startsWith('/employee/promotion') }">
   ...
   <!-- My Timetable Menu -->
   <li v-if="staff && staff.teacher" :class="{ 'menu-item': true, 'active': $page.url.startsWith('/teacher/my-timetable') }">
