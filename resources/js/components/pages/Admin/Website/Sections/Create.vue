      ...
      <div class="col-xl-12 col-md-12">
         <div class="card">
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-4 col-12">
                                    <div class="mb-3">
                                       ...
                                       <input id="subSectionOrder" type="number" class="form-control"
                                              v-model="sub.order">
                                 ...
                                 <div v-if="sub.type" class="col-md-12 col-12">
                                    <div class="mb-3">
                                       <div v-if="sub.type === 1">
                                          ...
                                          <div v-if="getSubSectionError(index, subIndex, 'content')"
                                               class="text-danger">
                                       ...
                                       <div v-if="sub.type === 2">
                                          ...
                                          <input type="file" id="subSectionImage"
                                                 @change="subSectionImageUpload($event, sub)" class="form-control">
                                          <div v-if="getSubSectionError(index, subIndex, 'type_image')"
                                               class="text-danger">
            ...
            <div class="card-footer pt-6">
               ...
               <button v-if="form.sections.length" @click="saveSections" type="button"
