<template>
         ...
         <template #actions="props">
            <div class="dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="#" @click="editReligion(props.rowData)">
   ...
   <div
      class="modal fade"
      id="create-religion-modal"
      data-bs-backdrop="static"
      tabindex="-1"
      aria-labelledby="create-religion-modal-label"
      aria-hidden="true"
      ref="createReligionModal"
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="create-religion-modal-label">Add Religion</h5>
               <button
                  type="button"
                  class="btn-close"
            ...
            <div class="modal-body">
               <form id="createForm" @submit.prevent="createReligion">
                  <div class="mb-3">
   ...
   <div
      class="modal fade"
      id="edit-religion-modal"
      data-bs-backdrop="static"
      tabindex="-1"
      aria-labelledby="edit-religion-modal-label"
      aria-hidden="true"
      ref="editReligionModal"
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="edit-religion-modal-label">Edit Religion</h5>
               <button
                  type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
            ...
            <div class="modal-body">
               <form id="createForm" @submit.prevent="updateReligion">
                  <div class="mb-3">
                     <label for="name" class="form-label">Name</label>
...
export default {
   ...
   methods: {
      showCreateReligionModal() {
         const modalElement = this.$refs.createReligionModal;
         const modalInstance = Modal.getOrCreateInstance(modalElement);
         modalInstance.show();
      },
      createReligion() {
         this.form.post(route('admin.religions.store'), {
            onSuccess: () => {
               this.form.reset();
               this.form.clearErrors();
               this.$refs.religionsTable.reloadTable();
               const modalElement = this.$refs.createReligionModal;
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Religion Created Successfully', 'Success')
            },
            onError: (errors) => {
      ...
      editReligion(rowData) {
         this.editForm.id = rowData.hashid;
         this.editForm.name = rowData.name;
         this.editForm.activated = rowData.activated;
         
         const modalElement = this.$refs.editReligionModal;
         const modalInstance = Modal.getOrCreateInstance(modalElement);
         modalInstance.show();
      },
      updateReligion() {
         this.editForm.patch(route('admin.religions.update', this.editForm.id), {
            onSuccess: () => {
               this.editForm.reset();
               ...
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Religion Updated Successfully', 'Success')
            },
            onError: (errors) => {
               this.$toast.error('An error occurred. Please try again', 'Error')
            },
