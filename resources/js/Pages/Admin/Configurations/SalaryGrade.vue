<template>
   <div class="card">
               ...
               <div class="flex-wrap text-end">
                  <div class="card-action">
                     <button type="button" class="btn btn-primary d-none d-sm-inline-block"
                             @click="showCreateSalaryGradeModal">
      ...
      <VueTable
         :fields="fields"
         api-url="datatable/salary-grades"
         :append-params="appendParams"
         ref="SalaryGradesTable"
      >
         ...
         <template #actions="props">
            <div class="dropdown">
               ...
               <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="#" @click="editSalaryGrade(props.rowData)">
   ...
   <div
      class="modal fade"
      id="create-salary-grade-modal"
      data-bs-backdrop="static"
      tabindex="-1"
      aria-labelledby="create-salary-grade-modal-label"
      aria-hidden="true"
      ref="createSalaryGradeModal"
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="create-salary-grade-modal-label">Add Salary Grade</h5>
               <button
                  type="button"
                  class="btn-close"
            ...
            <div class="modal-body">
               <form id="createForm" @submit.prevent="createSalaryGrade">
                  <div class="mb-3">
            ...
            <div class="modal-footer">
               ...
               <button
                  ...
                  @click.prevent="createSalaryGrade"
               >
                  Submit
               </button>
            </div>
   ...
   <div
      class="modal fade"
      id="edit-salary-grade-modal"
      data-bs-backdrop="static"
      tabindex="-1"
      aria-labelledby="edit-salary-grade-modal-label"
      aria-hidden="true"
      ref="editSalaryGradeModal"
   >
      <div class="modal-dialog">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="edit-salary-grade-modal-label">Edit Salary Grade</h5>
               <button
                  type="button"
                  class="btn-close"
                  data-bs-dismiss="modal"
            ...
            <div class="modal-body">
               <form id="createForm" @submit.prevent="updateSalaryGrade">
                  <div class="mb-3">
                     <label for="name" class="form-label">Name</label>
            ...
            <div class="modal-footer">
               ...
               <button
                  type="button"
                  class="btn btn-primary"
                  @click.prevent="updateSalaryGrade"
               >
                  Submit
               </button>
            </div>
...
export default {
   ...
   methods: {
      showCreateSalaryGradeModal() {
         const modalElement = this.$refs.createSalaryGradeModal;
         const modalInstance = Modal.getOrCreateInstance(modalElement);
         modalInstance.show();
      },
      createSalaryGrade() {
         this.form.post(route('admin.salary-grades.store'), {
            onSuccess: () => {
               this.form.reset();
               this.form.clearErrors();
               this.$refs.salaryGradesTable.reloadTable();
               const modalElement = this.$refs.createSalaryGradeModal;
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Salary Grade Created Successfully', 'Success')
            },
            onError: (errors) => {
      ...
      editSalaryGrade(rowData) {
         ...
         const modalElement = this.$refs.editSalaryGradeModal;
         const modalInstance = Modal.getOrCreateInstance(modalElement);
         modalInstance.show();
      },
      updateSalaryGrade() {
         this.editForm.patch(route('admin.salary-grades.update', this.editForm.id), {
            onSuccess: () => {
               ...
               const modalInstance = Modal.getInstance(modalElement);
               modalInstance.hide();
               this.$toast.success('Salary Grade Updated Successfully', 'Success')
            },
            onError: (errors) => {
               this.$toast.error('An error occurred. Please try again', 'Error')
            },
