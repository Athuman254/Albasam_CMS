        ...
        <div class="summary-box">
            <div class="row text-center">
                <div class="col-md-3 border-end">
                    ...
                    <div class="summary-value">Ksh {{ number_format($totalFees, 2) }}</div>
                </div>
                <div class="col-md-3 border-end">
                    <div class="compact-text"><strong>Total Paid</strong></div>
                    <div class="summary-value">Ksh {{ number_format($totalPaid, 2) }}</div>
                </div>
                <div class="col-md-3 border-end">
                    ...
                    <table class="table table-sm table-bordered mb-0 table-smaller">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>T{{ $fee->term }}</td>
                                <td class="text-end fw-bold">Ksh {{ number_format($fee->amount, 2) }}</td>
                                <td class="text-end">-</td>
                            ...
                            <tr>
                                ...
                                <td class="text-end">-</td>
                                <td class="text-end fw-bold">Ksh {{ number_format($payment->amount, 2) }}</td>
                                <td class="text-end fw-bold">
                                    Ksh {{ number_format($runningBalance, 2) }}
                                </td>
